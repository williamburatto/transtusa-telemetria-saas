...
<style>
    ...
    .badge-local { background-color: #DCFCE7; color: #15803D; padding: 4px 8px; border-radius: 6px; font-weight: bold; font-size: 0.8rem; }
    .badge-pr { background-color: #DBEAFE; color: #1D4ED8; padding: 4px 8px; border-radius: 6px; font-weight: bold; font-size: 0.8rem; }
    .badge-br { background-color: #FEF3C7; color: #B45309; padding: 4px 8px; border-radius: 6px; font-weight: bold; font-size: 0.8rem; }
...
<div class="main-header">
    <div style="display: flex; justify-content: space-between; align-items: center;">
        <div>
            ...
            <p>Sistema de Telemetria CAN Bus, Gestão de Frota (301 Ônibus), Marketplace B2B de Peças e Análise Financeira</p>
        </div>
...
# ==============================================================================
tab_dash, tab_sensores, tab_vendors, tab_finan, tab_driver, tab_api, tab_mapa = st.tabs([
    "📊 Dashboard & Preditivo",
    "🧰 Sensores & Alocação",
...
# ==============================================================================
# ABA 2: SENSORES & ALOCAÇÃO NO ÔNIBUS
# ==============================================================================
with tab_sensores:
...
# ==============================================================================
# ABA 3: MARKETPLACE DE FORNECEDORES
# ==============================================================================
with tab_vendors:
    ...
    st.markdown("#### 💰 Comparativo de Preços de Peças por Canal de Compra")
    df_pecas = pd.DataFrame({
        "Componente": ["Jogo Lonas de Freio (MBB O-500)", "Tambor de Freio Traseiro Urbano", "Kit Embreagem Completo (Sachs)", "Filtro Diesel S10 (Caixa 10un)", "Lanterna LED Traseira"],
        "Varejo Local (Joinville)": ["R$ 680,00", "R$ 1.305,00", "R$ 4.200,00", "R$ 1.850,00", "R$ 450,00"],
        "Hub Regional (Paraná)": ["R$ 520,00", "R$ 1.050,00", "R$ 3.400,00", "R$ 1.400,00", "R$ 350,00"],
        "Atacado Nacional (SP/RS)": ["R$ 420,00", "R$ 820,00", "R$ 2.850,00", "R$ 1.100,00", "R$ 270,00"],
        "Economia por Volume": ["38.2%", "37.2%", "32.1%", "40.5%", "40.0%"]
    })
    st.dataframe(df_pecas, use_container_width=True)

# ==============================================================================
# ABA 4: SIMULADOR INTERATIVO DE FINANCIAMENTO BNDES
# ==============================================================================
with tab_finan:
...
# ==============================================================================
# ABA 5: PAINEL EMBARCADO DO MOTORISTA
# ==============================================================================
with tab_driver:
    ...
    with col_d2:
        ...
        if freio_mm < 3.0:
            ...
            <div style="background-color: #FEF2F2; border-left: 6px solid #EF4444; padding: 15px; border-radius: 8px;">
                ...
                <b>Ação Automática:</b> Peça reservada no almoxarifado via IA. Manutenção agendada para o término do turno na garagem.</p>
            </div>
...
with tab_api:
    ...
    with col_a2:
        ...
        * **`GET /api/v1/marketplace/pedidos`**: Lista ordens de compras automáticas de peças.
        * **`GET /api/v1/dashboard/executivo`**: Métricas consolidadas para a diretoria.
        ...
        if st.button("🚀 Simular Ingestão Telemétrica no Servidor"):
            st.success("✅ Pacote telemétrico processado! Alerta gerado para substituição de lona de freio em 2.8 mm.")

# ==============================================================================
# ABA 7: MAPA DAS LINHAS DE JOINVILLE
# ==============================================================================
with tab_mapa:
